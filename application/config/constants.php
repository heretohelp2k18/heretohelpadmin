...
defined('DEFAULT_MESSAGE_TO_GUEST') OR define('DEFAULT_MESSAGE_TO_GUEST', "Hi, as guest you will be able to use the app for 3 hours. To keep on chatting with our psychologists, please click the sign up button.");